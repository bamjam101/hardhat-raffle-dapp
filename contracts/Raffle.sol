...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
   ...
   * @param gasLane is gas configuration (30 gwei)
   * @param subscriptionId The subscription id to authenticate to Chainlink VRF
   * @param callbackGasLimit is gas cost limit to avoid occurance of extensively high gas consuming operation
   * @param interval is interval defined for Chainlink Keepers to automate the contract
   */
  constructor(
    bytes32 gasLane,
